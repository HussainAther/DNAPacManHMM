...
# CG Island Probability dictionary
"""
From the 'Biological Sequence Analysis: Probabilistic Models of Proteins and Nucleic Acids' handbook (https://www.cambridge.org/core/books/biological-sequence-analysis/921BB7B78B745198829EF96BC7E0F29D) 
...
# The probability dictionaries give you the probabilty of moving
# from one letter to another with the first letter in the dictionary key 
# as the original letter and the second letter as the next letter. 

# The first dictionary has the probabilities in a CG island, and the 
# second one has the probabilities when not in a CG island.  
pdictcg = {
    "AA" : .180, "AC" : .274, "AG" : .426, "AT" : .120,
    "CA" : .171, "CC" : .368, "CG" : .274, "CT" : .188,
    "GA" : .161, "GC" : .339, "GG" : .375, "GT" : .125,
    "TA" : .079, "TC" : .355, "TG" : .384, "TT" : .182 
}

# probability dictionary without CG island
pdict = {
    "AA" : .300, "AC" : .205, "AG" : .285, "AT" : .210,
    "CA" : .322, "CC" : .298, "CG" : .078, "CT" : .302,
    "GA" : .248, "GC" : .246, "GG" : .298, "GT" : .208,
    "TA" : .177, "TC" : .239, "TG" : .292, "TT" : .292 
}

"""
These next dictionaries gives the individual probability of the 
next letter based on the previous letter. They are dictionaries of dictionaries.
The key is the previous letter, and the value is the next letter 
based on the probabilities given above.
"""
...
def weighted_random_by_dct(dct):
    """
    For a dictionary dct, draw a random number between 0 and 1,
    and identify which key should follow from the dictionary 
    with keys corresponding to the next base to choose based 
